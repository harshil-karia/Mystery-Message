...
export const badWordsList = {
    english: [
      'damn', 'hell', 'crap', 'ass', 'bastard', 'bitch', 'dick', 'fuck', 'shit', 'piss', 
      'cunt', 'whore', 'slut', 'douche', 'asshole', 'motherfucker', 'bullshit', 'jackass', 
      'cock', 'prick', 'nigger', 'spic', 'chink', 'fag', 'dyke', 'retard','chutiya', 'madarchod', 'bhenchod', 'sala', 'harami', 'gandu', 'bhosadiwala', 'lund', 'kamine',
